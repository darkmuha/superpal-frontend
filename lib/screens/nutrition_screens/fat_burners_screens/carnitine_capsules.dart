...
class CarnitineCapsulesScreen extends StatelessWidget {
  const CarnitineCapsulesScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return const ReusableInfoScreen(
      titleText: 'L - CARNITINE CAPSULES',
      imageUrl: 'assets/images/carnitine_capsules.jpg',
      explanationText:
